...
static void BindSol2Zombie(sol::state_view& lua) {
    auto ut = lua.new_usertype<Zombie>("PvZ.Zombie",
        ...
        "is_boss_damageable", &Zombie::IsBossDamageable,
        "is_in_off_ground_phase", &Zombie::IsInOffGroundPhase,
        ...
        "rise_from_grave_in_pool", &Zombie::RiseFromGraveInPool,
        "rise_from_grave_on_land", &Zombie::RiseFromGraveOnLand,
        ...
        "update_dancer_summon_counter", &Zombie::UpdateDancerSummonCounter,
        "update_dancer_snapping_fingers", &Zombie::UpdateDancerSnappingFingers,
        "transition_dancer_phase", &Zombie::TransitionDancerPhase,
        ...
        "play_yucky_sound", &Zombie::PlayYuckySound,
        "calc_yucky_face_row_change", &Zombie::CalcYuckyFaceRowChange,
        ...
        "update_helm_damage_image_override", &Zombie::UpdateHelmDamageImageOverride,
